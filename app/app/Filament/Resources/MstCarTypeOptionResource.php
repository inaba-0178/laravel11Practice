...
use App\Filament\Pages\MstCarTypeOptionDetail;
use App\Filament\Resources\MstCarTypeOptionResource\Pages;
...
class MstCarTypeOptionResource extends Resource
{
    ...
    protected static ?int    $navigationSort   = NavigationSort::MST_CAR_TYPE_OPTION->value;
    protected static ?string $pluralModelLabel = '車種タイプオプション一覧';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                Action::make('detail')
                    ->label('詳細')
                    ->url(fn(MstCarTypeOption $record) => MstCarTypeOptionDetail::getUrl(['id' => $record->id])),
    ...
    {
        return [
            'index' => Pages\ListMstCarTypeOptions::route('/'),
        ];
    }
}
